...
export const fallbackData = {
  ...
  about: {
    bio: "<p>Add your bio in WordPress (Site Content → About). This placeholder appears only when the CMS has no content yet.</p>",
    skills: [
      "Risk Assessment",
      "Permit-to-Work (PTW)",
  ...
  experience: [
    {
      ...
      responsibilities: [
        "Add your experience entries in WordPress (Experience post type).",
        "Each role supports company, location, dates and responsibilities.",
      ],
    },
  ],
  achievements: [
  ...
  projects: [
    {
      ...
      role: "HSE Officer",
      description:
        "Add your projects in WordPress (Project post type) — title, role, description and image.",
      image: null,
    },
  ],
  posts: [],
